      ...
      <div className="flex md:flex-row items-start gap-6 lg:gap-8 w-full flex-wrap justify-center md:justify-start lg:justify-between">
        ...
        <div className="flex flex-col items-start gap-2.5 md:flex-1 lg:max-w-[435px]">
          ...
          <div className="w-full">
            Ready to build something together? Contact me via my LinkedIn account below or you can email me directly at: <Link href="mailto:prismwolf@gmail.com" className="font-bold underline gradient-green-to-blue-horizontal">prismwolf@gmail.com</Link>.
          </div>
